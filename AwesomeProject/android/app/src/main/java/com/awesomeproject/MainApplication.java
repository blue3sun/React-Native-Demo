    ...
    public void onCreate() {
        ...
        PrinterHolder.setPrinter(new Printer() {
            ...
            public void logMessage(DebugOverlayTag tag, String message, Object... args) {
                Log.i(tag.name, "thread:" + Thread.currentThread().getName() + "   message:" + message + "   args:" + Arrays.toString(args));
            }

            @Override
            public void logMessage(DebugOverlayTag tag, String message) {
                Log.i(tag.name, "thread:" + Thread.currentThread().getName() + "   message:" + message);
            }
